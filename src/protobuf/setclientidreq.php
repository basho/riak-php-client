...
class SetClientIdReq {
  ...
  function read($fp, &$limit = PHP_INT_MAX) {
    while(!feof($fp) && $limit > 0) {
      ...
      $wire  = $tag & 0x07;
      $field = $tag >> 3;
      //var_dump("SetClientIdReq: Found $field type " . Protobuf::get_wiretype($wire) . " $limit bytes left");
      switch($field) {
        case 1:
          ASSERT('$wire == 2');
  ...
  // @@protoc_insertion_point(class_scope:SetClientIdReq)
}
