...
class Object
{
    ...
    {
        if (isset($this->headers['last-modified']) || array_key_exists('last-modified', $this->headers)) {
     ...
     * @param int|string|null $explicitValue - If provided, uses this
     ...
     * vector clock.
     *
     * @param integer $w - W-value, wait for this many partitions to respond before returning to client.
     * @param integer $dw - DW-value, wait for this many partitions to confirm the write before returning to client.
     *
     * @return $this
     *
     * @throws Exception
     ...
     *
     * @param integer $r - R-Value, wait for this many partitions to respond before returning to client.
     *
     * @return $this
     */
     ...
     *
     * @param integer $dw - DW-value. Wait until this many partitions have deleted the object before responding.
     *
     * @return $this
     */
    ...
    {
        if (isset($this->headers['x-riak-vclock']) || array_key_exists('x-riak-vclock', $this->headers)) {
     ...
     * @throws Exception
     */
    public function populate(array $response, array $expected_statuses)
    {
        $this->clear();
