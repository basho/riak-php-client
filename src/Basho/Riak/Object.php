...
class Object
{
     ...
     * @param string $key - An optional key. If not specified, then key is generated by server when store(...) is called.
     */
    public function __construct(Riak $client, Bucket $bucket, $key = null)
    {
        $this->client = $client;
        $this->bucket = $bucket;
        $this->key = $key;
     ...
     * @param string $tag - Optional link tag. (default is bucket name, ignored if $obj is a Link object.)
     *
     * @return Object
     */
     ...
     * @param string $indexType - Must be one of 'int' or 'bin' - the only two index types supported by Riak
     * @param string|int $explicitValue - Optional. If provided, uses this value explicitly.
     * If not provided, this will search the object's data for a field with the name $indexName, and use that value.
     *
     * @return Object
     */
     ...
     * @param string $indexType - optional
     *
     * @return Object
     */
     ...
     * vector clock.
     *
     * @param int $w - W-value, wait for this many partitions to respond before returning to client.
     * @param int $dw - DW-value, wait for this many partitions to confirm the write before returning to client.
     *
     * @return Object
     *
     * @throws Exception
     ...
     *
     * @param int $r - R-Value, wait for this many partitions to respond before returning to client.
     *
     * @return Object
     */
     ...
     *
     * @param  int $dw - DW-value. Wait until this many partitions have deleted the object before responding.
     *
     * @return Object
     */
     ...
     * @throws Exception
     */
    public function populate($response, array $expected_statuses)
    {
        $this->clear();
     ...
     * @param int $r - R-Value. Wait until this many partitions have responded before returning to client.
     *
     * @return Object.
     */
